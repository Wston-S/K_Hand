...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t buf_1[TFT_WIDTH * 10];                          /*A buffer for 10 rows*/
    lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, NULL, TFT_WIDTH * 10);   /*Initialize the display buffer*/
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    lv_disp_flush_ready(disp_drv); //调用区域填充颜色函数
#if 0    
